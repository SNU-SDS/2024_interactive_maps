...
```{r}
df_2022 <- read_excel("DM_Comp_Code_Mig_2022_Sidogungu.xlsx") 
...
```{r}
#| results: hide
seoul <- st_read("SEOUL_SIDO_2022_4Q.shp", options = "ENCODING=CP949")
seoul_gu <- st_read("SEOUL_GU_2022_4Q.shp", options = "ENCODING=CP949")
```
